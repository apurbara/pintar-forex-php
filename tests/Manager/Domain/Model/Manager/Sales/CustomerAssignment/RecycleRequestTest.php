...
class RecycleRequestTest extends TestBase
{
    ...
    {
        $this->recycleRequest->assertBelongsToManager($this->manager);
    }
    public function test_assertBelongsToManager_customerAssignmentDoesNotBelongsToManager_forbidden()
    {
        $this->assertRegularExceptionThrowed(fn() => $this->assertBelongsToManager(), 'Forbidden', 'recycle request does not belongs to manager');
    }
    public function test_assertBelongsToManager_customerAssignmentBelongsToManager_void()
    {
        $this->customerAssignment->expects($this->once())
