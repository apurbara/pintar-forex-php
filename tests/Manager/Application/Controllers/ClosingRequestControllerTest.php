...
class ClosingRequestControllerTest extends ManagerControllerTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->closingRequestMonthMinOneOne->columns['createdTime'] = (new DateTimeImmutable('first day of -1 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinOneTwo->columns['createdTime'] = (new DateTimeImmutable('first day of -1 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinOneThree->columns['createdTime'] = (new DateTimeImmutable('first day of -1 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinTwoOne->columns['createdTime'] = (new DateTimeImmutable('first day of -2 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinThreeOne->columns['createdTime'] = (new DateTimeImmutable('first day of -3 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinFourOne->columns['createdTime'] = (new DateTimeImmutable('first day of -4 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinFourTwo->columns['createdTime'] = (new DateTimeImmutable('first day of -4 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinFiveOne->columns['createdTime'] = (new DateTimeImmutable('first day of -5 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinSixOne->columns['createdTime'] = (new DateTimeImmutable('first day of -6 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinSixTwo->columns['createdTime'] = (new DateTimeImmutable('first day of -6 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinEighxOne->columns['createdTime'] = (new DateTimeImmutable('first day of -8 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinNineOne->columns['createdTime'] = (new DateTimeImmutable('first day of -9 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinElevenxOne->columns['createdTime'] = (new DateTimeImmutable('first day of -11 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinTwelveOne->columns['createdTime'] = (new DateTimeImmutable('first day of -12 months'))->format('Y-m-d H:i:s');
        ...
        $this->closingRequestMonthMinThirteenOne->columns['createdTime'] = (new DateTimeImmutable('first day of -13 months'))->format('Y-m-d H:i:s');
...
_QUERY;
    ...
    public function test_monthlyTotalTransaction_200()
    {
        ...
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -1 months'))->format('Ym'), 'totalTransaction' => 36000000]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -2 months'))->format('Ym'), 'totalTransaction' => 21000000]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -3 months'))->format('Ym'), 'totalTransaction' => 31000000]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -4 months'))->format('Ym'), 'totalTransaction' => 83000000]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -5 months'))->format('Ym'), 'totalTransaction' => 51000000]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -6 months'))->format('Ym'), 'totalTransaction' => 123000000]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -8 months'))->format('Ym'), 'totalTransaction' => 81000000]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -9 months'))->format('Ym'), 'totalTransaction' => 91000000]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -11 months'))->format('Ym'), 'totalTransaction' => 111000000]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -12 months'))->format('Ym'), 'totalTransaction' => 121000000]);
    }
    //
...
_QUERY;
    ...
    public function test_monthlyTransactionCount_200()
    {
        ...
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -1 months'))->format('Ym'), 'closingCount' => 3]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -2 months'))->format('Ym'), 'closingCount' => 1]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -3 months'))->format('Ym'), 'closingCount' => 1]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -4 months'))->format('Ym'), 'closingCount' => 2]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -5 months'))->format('Ym'), 'closingCount' => 1]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -6 months'))->format('Ym'), 'closingCount' => 2]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -8 months'))->format('Ym'), 'closingCount' => 1]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -9 months'))->format('Ym'), 'closingCount' => 1]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -11 months'))->format('Ym'), 'closingCount' => 1]);
        $this->seeJsonContains(['yearMonth' => (new DateTime('first day of -12 months'))->format('Ym'), 'closingCount' => 1]);
    }
