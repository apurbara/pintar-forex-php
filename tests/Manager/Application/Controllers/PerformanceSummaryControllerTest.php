...
class PerformanceSummaryControllerTest extends ManagerControllerTestCase
{
    ...
    protected EntityRecord $strikingAssignmentOneA, $customerAssignmentOneA;
    protected EntityRecord $strikingAssignmentTwoA, $customerAssignmentTwoA;
    protected EntityRecord $strikingAssignmentThreeA, $customerAssignmentThreeA;
    ...
    protected function setUp(): void
    {
        ...
        $this->salesRankTwo->columns['salesMetricType'] = SalesMetricType::SALES_ACTIVITY->value;
        ...
        $this->salesThree->columns['Manager_id'] = $this->manager->columns['id'];
        
        //
        $this->customerAssignmentOneA = new EntityRecord(CustomerAssignment::class, 'OneA');
        $this->strikingAssignmentOneA = new EntityRecord(StrikingAssignment::class, 'OneA');
        $this->strikingAssignmentOneA->columns['CustomerAssignment_id'] = $this->customerAssignmentOneA->columns['id'];
        $this->strikingAssignmentOneA->columns['id'] = $this->customerAssignmentOneA->columns['id'];
        $this->strikingAssignmentOneA->columns['Sales_id'] = $this->salesOne->columns['id'];
        
        $this->customerAssignmentTwoA = new EntityRecord(CustomerAssignment::class, 'TwoA');
        $this->strikingAssignmentTwoA = new EntityRecord(StrikingAssignment::class, 'TwoA');
        $this->strikingAssignmentTwoA->columns['CustomerAssignment_id'] = $this->customerAssignmentTwoA->columns['id'];
        $this->strikingAssignmentTwoA->columns['id'] = $this->customerAssignmentTwoA->columns['id'];
        $this->strikingAssignmentTwoA->columns['Sales_id'] = $this->salesTwo->columns['id'];
        
        $this->customerAssignmentThreeA = new EntityRecord(CustomerAssignment::class, 'ThreeA');
        $this->strikingAssignmentThreeA = new EntityRecord(StrikingAssignment::class, 'ThreeA');
        $this->strikingAssignmentThreeA->columns['CustomerAssignment_id'] = $this->customerAssignmentThreeA->columns['id'];
        $this->strikingAssignmentThreeA->columns['id'] = $this->customerAssignmentThreeA->columns['id'];
        $this->strikingAssignmentThreeA->columns['Sales_id'] = $this->salesThree->columns['id'];
...
//        $this->customerAssignmentThreeA->columns['Sales_id'] = $this->salesThree->columns['id'];
        ...
        $this->closingRequestOngoingEvaluationTimeOneAOneA->columns['StrikingAssignment_id'] = $this->strikingAssignmentOneA->columns['id'];
        ...
        $this->closingRequestOngoingEvaluationTimeOneAOneB->columns['StrikingAssignment_id'] = $this->strikingAssignmentOneA->columns['id'];
        ...
        $this->closingRequestOngoingEvaluationTimeOneAOneC->columns['StrikingAssignment_id'] = $this->strikingAssignmentOneA->columns['id'];
        ...
        $this->closingRequestOngoingEvaluationTimeTwoAOneA->columns['StrikingAssignment_id'] = $this->strikingAssignmentTwoA->columns['id'];
        ...
        $this->closingRequestOngoingEvaluationTimeThreeAOneA->columns['StrikingAssignment_id'] = $this->strikingAssignmentThreeA->columns['id'];
        ...
        $this->closingRequestMinusOneEvaluationTimeOneAOneA->columns['StrikingAssignment_id'] = $this->strikingAssignmentOneA->columns['id'];
        ...
        $this->closingRequestMinusOneEvaluationTimeOneAOneB->columns['StrikingAssignment_id'] = $this->strikingAssignmentOneA->columns['id'];
        ...
        $this->closingRequestMinusOneEvaluationTimeTwoAOneA->columns['StrikingAssignment_id'] = $this->strikingAssignmentTwoA->columns['id'];
        ...
        $this->closingRequestMinusOneEvaluationTimeThreeAOneA->columns['StrikingAssignment_id'] = $this->strikingAssignmentThreeA->columns['id'];
        ...
        $this->closingRequestMinusTwoEvaluationTimeOneAOneA->columns['StrikingAssignment_id'] = $this->strikingAssignmentOneA->columns['id'];
        ...
        $this->closingRequestMinusTwoEvaluationTimeOneAOneB->columns['StrikingAssignment_id'] = $this->strikingAssignmentOneA->columns['id'];
        ...
        $this->closingRequestMinusTwoEvaluationTimeTwoAOneA->columns['StrikingAssignment_id'] = $this->strikingAssignmentTwoA->columns['id'];
        ...
        $this->closingRequestMinusTwoEvaluationTimeThreeAOneA->columns['StrikingAssignment_id'] = $this->strikingAssignmentThreeA->columns['id'];
        ...
        $this->closingRequestMinusThreeEvaluationTimeOneAOneA->columns['StrikingAssignment_id'] = $this->strikingAssignmentOneA->columns['id'];
        ...
        $this->closingRequestMinusThreeEvaluationTimeOneAOneB->columns['StrikingAssignment_id'] = $this->strikingAssignmentOneA->columns['id'];
        ...
        $this->closingRequestMinusThreeEvaluationTimeTwoAOneA->columns['StrikingAssignment_id'] = $this->strikingAssignmentTwoA->columns['id'];
        ...
        $this->closingRequestMinusThreeEvaluationTimeThreeAOneA->columns['StrikingAssignment_id'] = $this->strikingAssignmentThreeA->columns['id'];
    ...
    protected function viewAllCompanyMetricSummary()
    {
        ...
        $this->strikingAssignmentOneA->insert($this->connection);
        $this->customerAssignmentTwoA->insert($this->connection);
        $this->strikingAssignmentTwoA->insert($this->connection);
        $this->customerAssignmentThreeA->insert($this->connection);
        $this->strikingAssignmentThreeA->insert($this->connection);
        ...
        $this->response = $this->get('api/manager/view-all-company-metric-summary', $this->manager->token);
    }
...
$this->disableExceptionHandling();
    ...
    protected function viewAllSalesRankSummary()
    {
        ...
        $this->response = $this->get('api/manager/view-all-sales-rank-summary', $this->manager->token);
    }
...
$this->disableExceptionHandling();
    ...
    protected function viewAllSalesPerformanceMetricSummary()
    {
        ...
        $this->response = $this->get('api/manager/view-all-sales-performance-metric-summary', $this->manager->token);
    }
