...
class VerificationReportTest extends TestBase
{
    ...
    protected function setUp(): void
    {
        ...
        $data = (new VerificationReportData())->setNote('note');
        $this->verificationReport = new TestableVerificationReport($this->customer, $this->customerVerification, 'id', $data);
    }
    ...
    {
        return new TestableVerificationReport($this->customer, $this->customerVerification, $this->id, $this->createData());
    }
